/// input_text_create(multiline, x, y, width, height, font, color, alpha, text wrapping width, max length, max lines, line seperation, halign, valign, text selection enabled, fit style)
...
with (instance) {
    ...
    cursor = spr_input_text_cursor_default; cursor_scale = 0.60//char_height / sprite_get_height(cursor);
